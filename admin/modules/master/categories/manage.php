...
<div class="container-fluid">
    <form action="" id="category-form">
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="form-group">
                    <label for="name" class="control-label text-info">Category Name</label>
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" cols="30" rows="3" class="form-control form-control-sm rounded-0 no-resize"><?php echo isset($description) ? htmlspecialchars($description) : ''; ?></textarea>
        </div>
