...
<div class="card card-outline card-primary shadow rounded-0">
    <div class="card-header">
        <h3 class="card-title"><?php echo isset($id) ? "Update Vendor - ".htmlspecialchars($name) : "Add New Vendor" ?></h3>
        <div class="card-tools">
            <a class="btn btn-flat btn-sm btn-dark" href="<?php echo base_url.'/admin?page=master/vendors'.(isset($id) ? '/view&id='.$id : '') ?>" title="Back"><i class="fa fa-angle-left"></i> Back</a>
        </div>
    </div>
    <div class="card-body">
        <form action="" id="vendor-form">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="name" class="control-label text-info">Vendor Name</label>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="cperson" class="control-label text-info">Contact Person</label>
                        <input type="text" name="cperson" id="cperson" class="form-control form-control-sm rounded-0" value="<?php echo isset($cperson) ? htmlspecialchars($cperson) : ''; ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="tax_id" class="control-label text-info">Tax ID / PAN / VAT</label>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="excise_license_no" class="control-label text-info">Excise License No</label>
                        <input type="text" name="excise_license_no" id="excise_license_no" class="form-control form-control-sm rounded-0" value="<?php echo isset($excise_license_no) ? htmlspecialchars($excise_license_no) : ''; ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" name="credit_limit" id="credit_limit" class="form-control form-control-sm rounded-0 text-right" value="<?php echo isset($credit_limit) ? $credit_limit : '0'; ?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="credit_days" class="control-label text-info">Credit Days</label>
                        <input type="number" name="credit_days" id="credit_days" class="form-control form-control-sm rounded-0 text-right" value="<?php echo isset($credit_days) ? $credit_days : '0'; ?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea rows="3" name="address" id="address" class="form-control form-control-sm rounded-0" placeholder="Street, Building, etc."><?php echo isset($address) ? htmlspecialchars($address) : ''; ?></textarea>
            </div>
        </form>
    </div>
    <div class="card-footer py-2 text-center">
        <button type="submit" form="vendor-form" class="btn btn-primary btn-flat btn-sm">Save Vendor</button>
        <a class="btn btn-secondary btn-flat btn-sm" href="<?php echo base_url.'/admin?page=master/vendors'.(isset($id) ? '/view&id='.$id : '') ?>">Cancel</a>
    </div>
</div>
<script>
            ...
            $.ajax({
                ...
                success: function(resp){
                    if(typeof resp == 'object' && resp.status == 'success'){
                        location.replace(_base_url_ + "admin/?page=master/vendors/view&id=" + resp.id);
