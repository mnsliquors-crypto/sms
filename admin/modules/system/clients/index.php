	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			...
			<div class="card-tools">
				...
				<a href="<?php echo base_url ?>admin/ajax/export_data.php?type=users" class="btn btn-flat btn-success"><span class="fas fa-download"></span>  Export</a>
			</div>
		</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		...
		$('.view_details').click(function(){
			...
			window.location.href = "<?php echo base_url ?>admin/?page=clients/view_details&id="+id;
		})
